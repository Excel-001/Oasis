...
//               <span
//                 className={`block absolute h-0.5 w-7 text-black bg-current transform transition duration-500 ease-in-out ${
...
//                 exit="closed"
//                 variants={variants} 
//           className={`lg:grid col-span-full pb-0 gap-4 lg:gap-0 lg:col-span-4 grid-cols-2 ${
//             open ? "grid" : "hidden"
//           }`}
//         >
...
//                    <button  onClick={() => setShowCart(true)} className="bg-[#F8F7FB] w-fit lg:h-14 lg:w-14 p-3 flex relative justify-center items-center rounded-full">
//               <svg
//                 xmlns="http://www.w3.org/2000/svg"
//                 width="24"
//                 height="24"
