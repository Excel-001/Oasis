...
function Accessories() {
    const tabs = [
        ...
        { id: "sofa", title: "Sofa", subcategory: "sofa" },
        { id: "accent chair", title: "Accent Chair", subcategory: "accent chair" },
        { id: "lounge chair", title: "Lounge Chair", subcategory: "lounge chair" },
        ...
        { id: "foam", title: "Foam", subcategory: "foam" },
        { id: "bed", title: "Bed", subcategory: "bed" },
      ...
      useEffect(() => {
        fetch("/products.json")
          ...
          console.log(accessoriesProducts)
            handleTabClick(selectedTab); // Initial tab click
          })
      ...
      const paths = ["Home", "Categories", "Accessories"];
  return (
    <>
